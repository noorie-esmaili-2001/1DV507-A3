...
public class NorseGod extends Application {
    ...
    public NorseGod(String name, String race, String decks) {
        setName(name);
        setRace(race);
        setDecks(decks);
    }
    ...
    public void start(Stage primaryStage) {
        ...
        listView.getSelectionModel().selectedItemProperty()
                .addListener((ObservableValue<? extends String> ov, String old_val, String new_val) -> {
                    switch (new_val) {
                        case "Odin" -> txtEra.setText(g1.getName() + "\n" + g1.getRace() + "\n" + "\n" + g1.getDecks());
                        case "Thor" -> txtEra.setText(g2.getName() + "\n" + g2.getRace() + "\n" + "\n" + g2.getDecks());
                        case "Loki" -> txtEra.setText(g3.getName() + "\n" + g3.getRace() + "\n" + "\n" + g3.getDecks());
                        case "Baldr" ->
                        ...
                        case "Tyr" -> txtEra.setText(g8.getName() + "\n" + g8.getRace() + "\n" + "\n" + g8.getDecks());
                    }
                });
